    ...
    if (cropName.isEmpty ||
      ...
      _showMessage(
        AppLanguage.text(
          ...
          'कृपया सबै आवश्यक विवरण सही रूपमा भर्नुहोस्।',
        ),
      );
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  AppLanguage.text(
                    'This photo is only shown before saving. It will not be uploaded because Firebase Storage is not enabled.',
                    'यो फोटो सेभ गर्नु अघि मात्र देखिन्छ। Firebase Storage enable नभएकाले upload हुँदैन।',
                  ),
