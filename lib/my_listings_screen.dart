...
class _MyListingsScreenState extends State<MyListingsScreen> {
  ...
  String _statusNe(String status) {
    if (status == 'sold') return 'बिक्री भयो';
    if (status == 'inactive') return 'निष्क्रिय';
    return 'सक्रिय';
  }
  ...
  Future<void> _updateStatus(String docId, String status) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(AppLanguage.text('Listing updated', 'लिस्टिङ अपडेट भयो')),
      ),
    );
  }
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text(
            AppLanguage.text(
              'This crop listing will be deleted permanently.',
              'यो बाली लिस्टिङ स्थायी रूपमा हटाइनेछ।',
            ),
          ),
          actions: [
            TextButton(
        ...
        return Padding(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  AppLanguage.text('Manage Listing', 'लिस्टिङ व्यवस्थापन'),
      ...
      builder: (context, language, child) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              AppLanguage.text('My Listings', 'मेरो लिस्टिङ'),
              ...
              builder: (context, snapshot) {
                if (FirebaseAuth.instance.currentUser == null) {
                  return _emptyState(
                    ...
                    subtitle: AppLanguage.text(
                      'Your crop listings are available after login.',
                      'तपाईंको बाली लिस्टिङ लगइन गरेपछि उपलब्ध हुन्छ।',
                    ),
                  );
                }
                ...
                if (docs.isEmpty) {
                  return _emptyState(
                    ...
                    title: AppLanguage.text(
                      'No listings yet',
                      'अहिलेसम्म लिस्टिङ छैन',
                    ),
                    subtitle: AppLanguage.text(
                      'Open Sell Crops and create your first listing.',
                      'Sell Crops खोलेर आफ्नो पहिलो लिस्टिङ बनाउनुहोस्।',
                    ),
                  );
                }
                  ...
                  children: [
                    ...
                    if (filteredDocs.isEmpty)
                      ...
                      ...filteredDocs.map((doc) {
                        return _myListingCard(docId: doc.id, data: doc.data());
                      }),
      ...
      child: Row(
        children: [
          const CircleAvatar(
            ...
            child: Icon(Icons.list_alt, color: Colors.green, size: 34),
          ),
          const SizedBox(width: 14),
          Expanded(
            child: Text(
              AppLanguage.text(
                '$count crop listings created',
                '$count बाली लिस्टिङ बनाइएको',
              ),
              style: const TextStyle(
                color: Colors.white,
                fontSize: 19,
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: AppLanguage.text(
            'Search crop, location, status or quality',
            'बाली, स्थान, स्थिति वा गुणस्तर खोज्नुहोस्',
          ),
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              _chip(
                label: AppLanguage.text(status, _statusNe(status)),
                color: statusColor,
              ),
              _chip(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            AppLanguage.text(
              'Try another crop, status or location.',
              'अर्को बाली, स्थिति वा स्थान खोज्नुहोस्।',
            ),
